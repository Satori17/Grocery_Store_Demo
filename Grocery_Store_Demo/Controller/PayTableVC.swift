...
extension PayVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.chosenFruitPrice.text = "\(String(format: "%.1f",newQuantity)) $"
        
       
        //Shadow for names
        cell.chosenFruitName.layer.shadowColor = UIColor(red: 0, green: 0, blue: 0, alpha: 0.5).cgColor
        cell.chosenFruitName.layer.shadowOffset = CGSize(width: 0.0, height: 5.0)
        cell.chosenFruitName.layer.shadowOpacity = 0.5
